...
// import { useDispatch, useSelector } from 'react-redux'
// import { addCourse, updateCourse } from '../store/formSlice'
...
//               <form onSubmit={handleSubmit}>
//                 <input type="text" id="newCourseInput" placeholder="Enter new course name"  onChange={(e) => setNewCourse(e.target.value)} />
//                 <input type="number"  placeholder="Enter new course price"  onChange={(e) => setNewPrice(e.target.value)} />
//                 {
//                   courses.id ?
//                   (
//                     <button className="btn btn-success" type="submit" > Update </button>
...
//   {
//                 courses && courses.map((data,idx) => (
//                   <CourseList key={data.id} idx ={idx}data={data} />
//                 ))
//               }
