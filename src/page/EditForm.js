...
//     useEffect(() => {
//         if (Object.key(task).length > 0 && task.id ) {
...
//                                             <div className="form-group">
//                                                 <label htmlFor="address">Address</label>
//                                                 <input type="address" className="form-control" id="address" placeholder="Address" onChange={(e) => setStudentForm({ address: e.target.value })} defaultValue={studentForm.address || ""} />
//                                             </div>
//                                             <div className="form-group">
//                                                 <label htmlFor="phone">Phone</label>
//                                                 <input type="number" className="form-control" id="phone" placeholder="Phone Number" onChange={(e) => setStudentForm({ ...studentForm, phone: e.target.value })} defaultValue={studentForm.phone || ""}
...
//                                             <div className="form-group">
//                                                 <label htmlFor="dob">Date Of Birth</label>
//                                                 <input type="dob" className="form-control" id="dob" placeholder="D/M/Y" onChange={(e) => setStudentForm({ dob: e.target.value })} defaultValue={studentForm.dob || ""} />
//                                             </div>

//                                             <div className="form-group">
//                                                 <label htmlFor="gender">Gender</label>
//                                                 <select className="form-control select2" style={{ width: "100%" }}
//                                                     onChange={(e) => setStudentForm({ ...studentForm, gender: e.target.value })} defaultValue={studentForm.gender || ""}>
//                                                     <option value="">Choose</option>
//                                                     <option value="male">Male</option>
//                                                     <option value="female">Female</option>
//                                                     <option value="other">Other</option>
...
//                                             <div className="form-group">
//                                                 <label htmlFor="course">Course:</label>
//                                                 <select onChange={(e) => setStudentForm({ ...studentForm, course: e.target.value })} defaultValue={studentForm.course || ""}>
//                                                     <option>Choose Any Course</option>
//                                                     {
//                                                         Course.map((data) => (
